...
class Enrollments {
    ...
    function getEnrollmentList($orderBy ='created_on desc') {
    	 $sql = 'SELECT
					id, father_name, father_cell, father_email,
					mother_name, mother_cell, mother_email, address,
        ...
        $enrollments = array();
        $stmt->bind_result($id, $father_name, $father_cell, $father_email,
				$mother_name, $mother_cell, $mother_email, $address,
				$city, $zipcode, $state, $phone, $language_primary, $language_other,
				$emergency_contact1, $emergency_phone1, $emergency_relation1,
				$emergency_contact2, $emergency_phone2, $emergency_relation2,
    ...
    function iudEnrollment($dml, $id, $father_name, $father_cell, $father_email,
				$mother_name, $mother_cell, $mother_email, $address,
				$city, $zipcode, $state, $phone, $language_primary, $language_other,
				$emergency_contact1, $emergency_phone1, $emergency_relation1,
        ...
        if ($dml!='d') {
        	$data = array(
        		...
        		'total_fee' => array('type' => 'i', 'value' => $total_fee),
        		'financial_aid' => array('type' => 'i', 'value' => $financial_aid)
	        );
        }
