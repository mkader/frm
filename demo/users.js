...
/*$(function(){
	if ($("#userlist").length>0){
		$("#userlist").ready(function () {*/
			$(gridid).jqGrid(common.gridOptions(gridpagerid, userColModel, 'User List', 'users_list.html', 900, null, null, 10, 230, common.ondblClickRow));
...
function fetchGridData() {
	common.setGridData(gridid,"get", "users_list.html", {action: 'userlist'}, pushData)
}
