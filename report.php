...
<div>
	...
	<div>
		<div><u><b>School</b></u></div>
		<ol>
			<li>
				Complete List-Excel
				<a href="report/schoolcompletelist.php?year=<?php echo date('Y')?>"><?php echo date('Y')?></a>
				<a href="report/schoolcompletelist.php?year=<?php echo date('Y')+1?>"><?php echo date('Y')+1?></a>
			</li><br>
			<li>
				Complete List-HTML
				<a target="self" href="report/schoolcompletelisthtml.php?year=<?php echo date('Y')?>"><?php echo date('Y')?></a>
				<a target="self" href="report/schoolcompletelisthtml.php?year=<?php echo date('Y')+1?>"><?php echo date('Y')+1?></a>
			</li><br>
		</ol>
	</div>
</div>
